...
public class LoginLocators {
    ...
    public static final By SEARCH_BUTTON_SIGN_IN = By.cssSelector("input[value='Sign in']");
    public static final By SEARCH_BUTTON_SIGN_OUT = By.xpath("//a[@data-test= 'sign-out']");
